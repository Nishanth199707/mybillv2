...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light"></span>  Purchase Return / Debit Note</h4>
                        ...
                        <div class="card-body p-32" id="tblData">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 fv-plugins-icon-container">
                                    ...
                                    <input type="text" id="formValidationName" class="form-control" required value="" name="purchase_no">
                            ...
                            <div class="m-1  justify-content-between align-items-center">
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-3 border p-2"> -->
                                        <!-- Total Amount: ₹ -->
                                        <input type="hidden" readonly class="totalstyle" name="totalAmountDisplay" id="totalAmountDisplay" value="0" />
        ...
        document.querySelectorAll('.addrowcontainer').forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                document.getElementById("addrow").insertAdjacentHTML('beforeend',
                    ...
                    `<div class="col-md-1 border p-2"><input class="form-control qtybox" tabindex="1" type="text" dataid="${cIncr}" name="qty${cIncr}" id="qty${cIncr}"></div>` +
                    ...
                    `<div class="col-md-1 border p-2"><input class="form-control gstperc" type="number" dataid="${cIncr}" name="gst${cIncr}" id="gst${cIncr}"><input class="gstvaldata" type="hidden" dataid="${cIncr}" name="gstvaldata${cIncr}" id="gstvaldata${cIncr}"></div>` +
