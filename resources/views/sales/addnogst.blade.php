        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('sale.store') }}" id="saleForm" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body p-32" id="tblData">
                            ...
                            <div class="row">
                            <div class="col-6"></div>
                                <div class="col-6" style="text-align: right;"><button type="button" class="btn btn-primary addrowcontainer float-right mb-2">Add New Row</button></div>
                            ...
                            <div class="m-1  justify-content-between align-items-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1 border p-2"></div>
                        ...
                        <div style="text-align: right;">
                            ...
                            <button id="saleFormSubmit" type="submit" class="btn btn-primary float-right mb-2">Save and Print</button>
                        </div>
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-3">
                            ...
                            <div>
                                ...
                                <input type="radio" id="purchase" name="transaction_type" value="purchase" disabled  />
