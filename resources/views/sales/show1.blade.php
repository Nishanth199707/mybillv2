                                                    ...
                                                    <div class="col-md-12">
                                                        <table style="width: 100%;">
                                                            <thead>
                                                                <tr>
                                                                    <th class="text-center"
                                                                        style="border: 0.5pt solid #303030;">Loan
                                                                        No.</th>
                                                                    <th class="text-center"
                                                                        style="border: 0.5pt solid #303030;">
                                                                        Financier</th>
                                                                    <th class="text-center"
                                                                        style="border: 0.5pt solid #303030;">IP
                                                                    </th>
                                                                    <th class="text-center"
                                                                        style="border: 0.5pt solid #303030;">EMI
                                                                    </th>
                                                                    <th class="text-center"
                                                                        style="border: 0.5pt solid #303030;">
                                                                        Scheme</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td
                                                                        style="border: 0.5pt solid #303030;padding: 5px;color:red;text-align: center;">
                                                                        {{ $emi->loan_no }}
                                                                    </td>
                                                                    <td
                                                                        style="border: 0.5pt solid #303030;padding: 5px;color:red;text-align: center;">
