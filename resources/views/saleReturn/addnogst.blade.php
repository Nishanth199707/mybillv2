            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0">Sale Return</h5>
                        <!-- <small class="text-muted float-end">Default label</small> -->
                    </div>
                    <div id="validation-errors-sale"></div>
                    <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('salereturns.store') }}" id="saleForm" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body p-32" id="tblData">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control" id="datetimepicker9" required name="return_invoice_date" value="{{ date('d-m-Y') }}">
                                    @if ($errors->has('return_invoice_date'))
                                ...
                                <div class="col-md-4 fv-plugins-icon-container">
                                    ...
                                    <input type="text" id="formValidationName" class="form-control" readonly placeholder="John Doe" value="{{ $invoice_no}}" name="return_invoice_no">
