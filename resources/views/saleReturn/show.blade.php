                                                        ...
                                                        <div class="row gy-3"
                                                            ...
                                                            <div class="col-sm-2"
                                                                ...
                                                                <p class=""
                                                                    ...
                                                                    No:</p>
                                                                <strong>{{ $salereturn->return_invoice_no }}</strong>
                                                                <hr>
                                                                <p class=""><strong>Inv Date:</strong><br>
                                                                    {{ $salereturn->return_invoice_date }}
                                                                </p>
                                                            ...
                                                            <div class="col-md-6">
                                                                <table class="table">
                                                                    ...
                                                                    <tr class="bg-light">
                                                                        ...
                                                                        <td class="text-end">Rs. {{ $salereturn->tax_amount }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
