            ...
            <div class="table-responsive">
                ...
                <tr class="bg-light">
                    ...
                    <tr class="bg-light">
                        ...
                        <td class="col-sm-2 text-end">Rs. {{ $sale->totalAmountDisplay }}</td>
                    </tr>
                    <tr class="bg-light">
                        <td class="text-end"><strong>Total Tax:</strong><br>
                        @if($sale->tax_amount_18_cgst)
                            9% CGST Rs. {{ $sale->tax_amount_18_cgst }}<br>
                            9% SGST Rs. {{ $sale->tax_amount_18_sgst }}<br>
                        @endif
                        @if($sale->tax_amount_12_cgst)
                            6% CGST Rs. {{ $sale->tax_amount_12_cgst }}<br>
                            6% SGST Rs. {{ $sale->tax_amount_12_sgst }}<br>
                            @endif
                        @if($sale->tax_amount_5_cgst)
                            2.5% CGST Rs. {{ $sale->tax_amount_5_cgst }}<br>
                            2.5% SGST Rs. {{ $sale->tax_amount_5_sgst }}<br>
                            @endif</td>
