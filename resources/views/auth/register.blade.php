...
<head>
    ...
    <title>SignUp Cover | MyDailyBill </title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="mb-4">
                                        <button class="btn btn-secondary w-100" style="background:linear-gradient(to right,#ff746e, #ff9e6f);border:none;">SIGN UP</button>
                                    </div>
                                </div>
                                </form>
