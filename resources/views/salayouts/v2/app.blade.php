...
<head>
    ...
    <title>SuperAdmin | MyDailyBill</title>
        ...
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        {{-- <img src="{{ asset('v2/src/assets/img/logo.svg') }}" class="navbar-logo" alt="logo"> --}}
                    </a>
                </li>
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        ...
                        <div class="dropdown-item">
                            ...
                            <form id="logout-form" action="{{ route('sadamin.logout') }}" method="POST" class="d-none">
                                @csrf
                            </form>
                        </div>
                        </a>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar" class="side_bar">
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        ...
                        <div class="nav-item theme-text">
                            <a href="{{ route('sa.home') }}" class="nav-link">
                                @if (Auth::user())
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu {{ Route::is('sa.home') ? 'active' : '' }}">
                        <a href="{{ route('sa.home') }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li class="menu {{ Route::is('sadamin.user') ? 'active' : '' }}">
                        <a href="{{ route('sadamin.user') }}" class="dropdown-toggle">
                            <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
                    ...
                    <li class="menu {{ Route::is('plans.index') ? 'active' : '' }}">
                        <a href="{{ route('plans.index') }}" class="dropdown-toggle">
                            <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
