        ...
        <header>
            <div class="row gy-3">
                <div class="col-12 text-center">
                    <h2 class="text-4">Purchase Return Invoice</h4>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-2">
                    <strong>Purchase No:</strong> {{ $purchasereturn->purchase_no }}
                </div>
            </div>
            <hr>
        </header>
        ...
        <main>
            <div class="row gy-3">
                <div class="col-sm-4">
                    ...
                    <p class="mb-1"><strong>Order Date:</strong> {{ $purchasereturn->purchase_date }}</p>
                    <p class="mb-1"><strong>Purchase Date:</strong> {{ $purchasereturn->purchase_date }}</p>
            ...
            <div class="table-responsive">
                ...
                <tr class="bg-light">
                    ...
                    <tr class="bg-light">
                        ...
                        <td class="col-sm-2 text-end">Rs. {{ $purchasereturn->totalAmountDisplay }}</td>
                    </tr>
                    <tr class="bg-light">
                        <td class="text-end"><strong>Total Tax:</strong><br>
                        @if($purchasereturn->tax_amount_18_cgst)
                            9% CGST Rs. {{ $purchasereturn->tax_amount_18_cgst }}<br>
                            9% SGST Rs. {{ $purchasereturn->tax_amount_18_sgst }}<br>
                        @endif
                        @if($purchasereturn->tax_amount_12_cgst)
                            6% CGST Rs. {{ $purchasereturn->tax_amount_12_cgst }}<br>
                            6% SGST Rs. {{ $purchasereturn->tax_amount_12_sgst }}<br>
                            @endif
                        @if($purchasereturn->tax_amount_5_cgst)
                            2.5% CGST Rs. {{ $purchasereturn->tax_amount_5_cgst }}<br>
                            2.5% SGST Rs. {{ $purchasereturn->tax_amount_5_sgst }}<br>
                            @endif</td>
                        <td class="col-sm-2 text-end">
                        Rs. {{ $purchasereturn->tax_amount }}
                        </td>
                    </tr>

                    <tr class="bg-light">
                        <td class="text-end"><strong>Grand Total:</strong></td>
                        <td class="col-sm-2 text-end">Rs. {{ $purchasereturn->net_amount }}</td>
                    </tr>
                </table>
            </div>
        </main>
