...
<div class="content-wrapper">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            @if(!empty($purchase->tax_amount_18_cgst))
            @else
            $('.eighteen').css({
                'display': 'none'
            });
            ...
            @if(!empty($purchase->tax_amount_12_cgst))
            @else
            ...
            @if(!empty($purchase->tax_amount_5_cgst))
            @else
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('purchase.show',$purchase->id)}}" id="saleForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4 fv-plugins-icon-container" id="tblDataparty">
                                    ...
                                    <div class="border p-2 input-group col-md-4">
                                        <input type="text" class="form-control party" id="party" required name="party" value="{{ $purchase->party }}">
                                        <input type="hidden" class="party" id="partyid" required name="partyid" value="{{ $purchase->id }}">
                                ...
                                <div class="col-md-4 fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control" id="datetimepicker9" required name="purchase_date" value="{{ $purchase->purchase_date }}">
                                ...
                                <div class="col-md-4 fv-plugins-icon-container">
                                    ...
                                    <input type="text" id="formValidationName" required class="form-control" value="" name="purchase_no" value="{{ $purchase->purchase_no }}">
                            ...
                            <div class="m-1  justify-content-between align-items-center" id="addrow">
                                ...
                                <div class="row">
                                    ...
                                    <div class="border p-2 input-group col-md-4" style="width: 33.33333333%;">
                                        ...
                                        <input type="hidden" name="purchase_detail_id{{$key+1}}" value="{{ $val->id}}" />
                            ...
                            <div class="m-1  justify-content-between align-items-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 border p-2">
                                        <!-- Total Amount: ₹ -->
                                        <input readonly class="totalstyle" type="hidden" name="totalAmountDisplay" id="totalAmountDisplay" value="{{ $purchase->totalAmountDisplay }}" />
                                        ...
                                        <div class="">
                                            <!-- <table class="gsttable"> -->
                                                ...
                                                <tr class="eighteen" style="display:block;">
                                                    <td>18%</td>
                                                    <td>CGST: ₹ <input type="text" readonly value="0" class="totalstyle1" name="tax_amount_18_cgst" id="taxAmount_18_cgst" value="{{ $purchase->tax_amount_18_cgst }}"></td>
                                                    <td>SGST: ₹ <input type="text" readonly value="0" class="totalstyle1" name="tax_amount_18_sgst" id="taxAmount_18_sgst" value="{{ $purchase->tax_amount_18_sgst }}"></td>
                                                </tr>
                                                @endif
                                                @if(!empty($purchase->tax_amount_12_cgst))
                                                ...
                                                <tr class="twelve" style="display:block;">
                                                    <td>12%</td>
                                                    <td>CGST: ₹ <input type="text" readonly value="0" class="totalstyle1" name="tax_amount_12_cgst" id="taxAmount_12_cgst" value="{{ $purchase->tax_amount_12_cgst }}"></td>
                                                    <td>SGST: ₹ <input type="text" readonly value="0" class="totalstyle1" name="tax_amount_12_sgst" id="taxAmount_12_sgst" value="{{ $purchase->tax_amount_12_sgst }}"></td>
                                                </tr>
                                                @endif
                                                @if(!empty($purchase->tax_amount_5_cgst))
                                                ...
                                                <tr class="five" style="display:block;">
                                                    <td>5%</td>
                                                    <td>CGST: ₹ <input type="text" readonly value="0" class="totalstyle1" name="tax_amount_5_cgst" id="taxAmount_5_cgst" value="{{ $purchase->tax_amount_5_cgst }}"></td>
                                                    <td>SGST: ₹ <input type="text" readonly value="0" class="totalstyle1" name="tax_amount_5_sgst" id="taxAmount_5_sgst" value="{{ $purchase->tax_amount_5_sgst }}"></td>
                                                </tr>
                                                @endif
                                    ...
                                    <div class="col-md-2 border p-2">
                                        <!-- <b class="mt-1">Tax: ₹</b> <input type="text" readonly value="0" class="totalstyle" name="tax_amount" id="taxAmount" value="{{ $purchase->tax_amount }}"> -->
                                    </div>
                                    <div class="col-md-3 border p-2">
                                        <b class="mt-1">Net Amount: ₹</b> <input readonly type="text" class="totalstyle" value="0" name="net_amount" id="netAmount" value="{{ $purchase->net_amount }}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4 fv-plugins-icon-container">
                                            ...
                                            <select name="cash_type" required id="cash_type" class="form-select">
                                                ...
                                                <option @if($purchase->cash_type==$key) selected @endif value="{{$key}}">{{$val}}</option>
                                                @endforeach
                                            </select>
                ...
                <div class="container-fluid invoice-container">
                    ...
                    <header>
                        <div class="row gy-3">
                            ...
                            <div class="col-sm-2">
                                <strong>Invoice No:</strong> {{ $purchase->purchase_no }}
                            </div>
                        </div>
                        <hr>
                    </header>
                    ...
                    <main>
                        <div class="row gy-3">
                            <div class="col-sm-4">
                                ...
                                <p class="mb-1"><strong>Invoice Date:</strong> {{ $purchase->purchase_date }}</p>
                        ...
                        <div class="table-responsive">
                            <table class="table border border-top-0 mb-0">
                                <tr class="bg-light">
                                    ...
                                    <td class="col-sm-2 text-end">{{ $purchase->totalAmountDisplay }}</td>
                                </tr>
                                <tr class="bg-light">
                                ...
                                <tr class="bg-light">
                                    ...
                                    <td class="col-sm-2 text-end">{{ $purchase->net_amount }}</td>
                                </tr>
                            </table>
                        </div>
                    </main>
        ...
        document.querySelectorAll('.addrowcontainer').forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                document.getElementById("addrow").insertAdjacentHTML('beforeend',
                    ...
                    `<div class="col-md-2 border p-2"><input class="form-control" type="number" name="total_amount${cIncr}" id="total_amount${cIncr}"></div>` +
                    `</div>`
                );
                initCalculation();
            });
